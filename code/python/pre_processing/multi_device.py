...
if __name__ == '__main__':
    ...
    if args.sync:
        ...
        gen_dataset.write_file(args.dir + '/nexus/gyro_sync.txt', gyro_nexus)
        gen_dataset.write_file(args.dir + '/nexus/acce_sync.txt', acce_nexus)
        gen_dataset.write_file(args.dir + '/nexus/linacce_sync.txt', linacce_nexus)
        gen_dataset.write_file(args.dir + '/nexus/magnet_sync.txt', magnet_nexus)
        gen_dataset.write_file(args.dir + '/nexus/orientation_sync.txt', rv_nexus)
